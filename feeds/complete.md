...
## lwcpa
- url: https://lwcpa.podbean.com/feed.xml
- title: Light of the World Church (video?)
- category: church
...
## gty
- url: https://www.gty.org/rss/video
- title: Grace to You
- category: church

## bvov
- url: https://www.bvov.tv/rss/video
- title: Believer's Voice of Victory
- category: church

## watermark
- url: https://www.watermark.org/feed/video
- title: Watermark
- category: church
...
## uctv_health
- url: http://podcast.uctv.tv/uctv_video_health.rss
- title: UCTV (health & medicine)
- category: university

## uctv_berkeley
- url: https://podcast.uctv.tv/UCTV_campus_berkeley_video.rss
- title: UCTV (UC Berkeley)
- category: university

## uctv_ucsf
- url: https://podcast.uctv.tv/UCTV_campus_ucsf_video.rss
- title: UCTV (UCSF)
- category: university

## uctv_davis
- url: https://podcast.uctv.tv/UCTV_campus_davis_video.rss
- title: UCTV (UC Davis)
- category: university
...
## atlantafirstumc_sermons
- url: https://www.atlantafirstumc.org/sermons/
- title: Atlanta First UMC (sermons page)
- category: needs-rss

## lifepoint_sermons
- url: https://www.lifepointtoday.net/sermons-main/
- title: Life Point Church (sermons page)
- category: needs-rss

## mvcnaz_sermon_video
- url: https://www.mvcnaz.org/wp4/?page_id=486
- title: MVC Naz (page says video podcast)
- category: needs-rss

## c3naz_sermon_archives_page
- url: https://www.c3naz.net/sermon-archives.html
- title: C3Naz (sermon archives page)
- category: needs-rss

## marshill_feeds_page
- url: http://marshill.info/marshill/feeds.html
- title: Mars Hill (feeds page)
- category: needs-rss

## oldstandrews_sermons
- url: https://oldstandrewschurch.org/sermons/
- title: Old St Andrews Church (sermons page)
- category: needs-rss

## ucsd_podcast_directory
- url: https://podcast.ucsd.edu/
- title: UC San Diego course podcasts (directory)
- category: needs-rss

## openyale_rss_page
- url: https://oyc.yale.edu/rss
- title: Open Yale Courses (RSS page)
- category: needs-rss

## kingdomwinds_video_podcast
- url: https://kingdomwinds.com/series/video-podcast/
- title: Kingdom Winds (video podcast page)
- category: needs-rss

## feedspot_church
- url: https://rss.feedspot.com/church_rss_feeds/
- title: Feedspot (church RSS directory)
- category: needs-rss

## feedspot_university
- url: https://rss.feedspot.com/university_rss_feeds/
- title: Feedspot (university RSS directory)
- category: needs-rss
...
- url: https://nutritionfacts.org/videos/feed/podcast/
- title: NutritionFacts.org Video Podcast
- category: podcastindex

## still-poddable
- url: https://feeds.megaphone.fm/NSM2691900547
- title: Still Poddable
- category: podcastindex

## security-weekly-podcast-network-video
- url: https://securityweeklytv.libsyn.com/rss
- title: Security Weekly Podcast Network
- category: podcastindex

## enterprise-security-weekly-video
- url: https://eswvideo.libsyn.com/rss
- title: Enterprise Security Weekly
- category: podcastindex

## video-gamers-podcast
- url: https://feeds.megaphone.fm/AMGAC9705074721
- title: Video Gamers Podcast
- category: podcastindex

## elder-scrolls-lorecast-skyrim-oblivion-eso-and-tes-vi-video-game-lore-more
- url: https://feeds.redcircle.com/4a1d1e81-82b0-43de-8343-04ea196a94f0
- title: Elder Scrolls Lorecast: Skyrim, Oblivion, ESO and TES VI Video Game Lore & More
- category: podcastindex
...
- url: https://feeds.redcircle.com/1ef83263-04d9-49eb-a974-9fd1fc990676
- title: Fallout Lorecast - The Fallout Video Game & TV Lore Podcast
- category: podcastindex

## the-corbett-report-videos
- url: https://www.corbettreport.com/videorss.xml
- title: The Corbett Report - Videos
- category: podcastindex
...
- url: https://newmediashow.com/feed/podcast/
- title: New Media Show
- category: podcastindex
...
- url: https://anchor.fm/s/170bee08/podcast/rss
- title: Theme Park Science - Behind the Video
- category: podcastindex
...
- url: https://feeds.twit.tv/brickhouse_video_hd.xml
...
## hands-on-tech-video
- url: https://feeds.twit.tv/hot_video_hd.xml
- title: Hands-On Tech
- category: twit

## this-week-in-space-video
- url: https://feeds.twit.tv/twis_video_hd.xml
- title: This Week in Space
- category: twit

## home-theater-geeks-video
- url: https://feeds.twit.tv/htg_video_hd.xml
- title: Home Theater Geeks
- category: twit

## hands-on-apple-video
- url: https://feeds.twit.tv/hom_video_hd.xml
- title: Hands-On Apple
- category: twit

## hands-on-windows-video
- url: https://feeds.twit.tv/howin_video_hd.xml
- title: Hands-On Windows
- category: twit

## untitled-linux-show-video
- url: https://feeds.twit.tv/uls_video_hd.xml
- title: Untitled Linux Show
- category: twit

## total-leo-video
- url: https://feeds.twit.tv/leo_video_hd.xml
- title: Total Leo
- category: twit
